...
export function TimelineTooltip({
  ...
  return (
    <div
      ref={tooltipRef}
      className={cn(
        "absolute z-[50] rounded-lg border border-border bg-glass p-3 text-foreground shadow-glass backdrop-blur-md transition-[opacity,transform] duration-200 ease-out",
        "pointer-events-none",
