...
import {
  ...
  COMPACT_TIMELINE_BOTTOM_PADDING_EXTRA,
  COMPACT_TIMELINE_BOTTOM_PADDING_MAX_HEIGHT,
...
export function getTimelineLayout(
  ...
  const compactBottomPadding =
    effectiveHeight <= COMPACT_TIMELINE_BOTTOM_PADDING_MAX_HEIGHT
      ? COMPACT_TIMELINE_BOTTOM_PADDING_EXTRA
      : 0;
  const timelineBottomPadding =
    TIMELINE_BOTTOM_PADDING + roomyBottomPadding + compactBottomPadding;
