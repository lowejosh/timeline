...
const HUMAN_HISTORY_COLORS = {
  ...
  chalcolithic: "rgb(230, 92, 45)",
  bronzeAge: "rgb(218, 154, 31)",
  earlyBronzeAge: "rgb(243, 199, 74)",
  middleBronzeAge: "rgb(222, 133, 35)",
  lateBronzeAge: "rgb(195, 96, 48)",
  ironAge: "rgb(55, 157, 238)",
  earlyIronAge: "rgb(95, 204, 242)",
  middleIronAge: "rgb(43, 142, 230)",
  lateIronAge: "rgb(41, 111, 205)",
  classicalAntiquity: "rgb(130, 84, 222)",
  persianAndClassicalGreekAge: "rgb(168, 119, 241)",
  hellenisticAge: "rgb(143, 96, 231)",
  romanAscendancy: "rgb(114, 78, 211)",
  lateAntiquity: "rgb(96, 78, 191)",
  postClassicalHistory: "rgb(69, 217, 98)",
  earlyMedievalAndIslamicExpansion: "rgb(78, 204, 134)",
  caliphatesTangSongAndFeudalWorlds: "rgb(45, 218, 171)",
  mongolAndHighMedievalAge: "rgb(54, 189, 129)",
  lateMedievalRecoveryAndEarlyGlobalTurn: "rgb(104, 219, 88)",
  ...
  ageOfIndustryAndEmpire: "rgb(125, 91, 232)",
  earlyIndustrialGrowth: "rgb(159, 134, 245)",
  nationalismAndExpansion: "rgb(134, 104, 240)",
  highIndustrializationAndEmpire: "rgb(103, 77, 220)",
  warAndCrisis: "rgb(166, 70, 190)",
...
export const HUMAN_HISTORY_ERA_DEFINITIONS: EraDefinition[] = [
  ...
  },
  {
    ...
    children: [
      {
        id: "persian-and-classical-greek-age",
        name: "Persian & Classical Greek Age",
        startYear: bce(539),
        endYear: bce(323),
        color: HUMAN_HISTORY_COLORS.persianAndClassicalGreekAge,
        description:
          "Achaemenid imperial power, Greek city-states, Greco-Persian war, and Alexander's campaigns set the classical eastern Mediterranean world in motion.",
        scheme: "world-history",
        sourceIds: ["historyPersianEmpire", "britannicaAncientGreece"],
      },
      {
        id: "hellenistic-age",
        ...
        startYear: bce(323),
        endYear: bce(31),
        color: HUMAN_HISTORY_COLORS.hellenisticAge,
        description:
          "Alexander's successor kingdoms spread Greek language, art, science, and court culture across Egypt, Anatolia, Syria, and western Asia.",
        scheme: "world-history",
        sourceIds: ["britannicaHellenisticAge"],
      },
      {
        id: "roman-ascendancy",
        name: "Roman Ascendancy",
        startYear: bce(31),
        endYear: ce(284),
        color: HUMAN_HISTORY_COLORS.romanAscendancy,
        description:
          "Rome consolidates Mediterranean rule under the Principate, turning republican conquest into an imperial urban, legal, and military order.",
        scheme: "world-history",
        sourceIds: ["khanRomanEmpire", "historyAncientRome"],
      },
      {
        id: "late-antiquity",
        name: "Late Antiquity",
        startYear: ce(284),
        endYear: ce(500),
        color: HUMAN_HISTORY_COLORS.lateAntiquity,
        description:
          "The late Roman world transforms through imperial reform, Christianization, regional fragmentation, and the early shape of Byzantine and medieval successor societies.",
        scheme: "world-history",
        sourceIds: ["locLateAntiquity"],
      },
    ],
  },
  {
    ...
    description:
      "Between ancient and early modern worlds, religions, regional states, and long-distance exchange bind Afro-Eurasia more tightly.",
    scheme: "world-history",
    image: {
    ...
    sourceIds: ["cambridgeWorldHistory5001500", "britannicaMiddleAges"],
    children: [
      {
        id: "early-medieval-and-islamic-expansion",
        name: "Early Medieval World",
        startYear: ce(500),
        endYear: ce(750),
        color: HUMAN_HISTORY_COLORS.earlyMedievalAndIslamicExpansion,
        description:
          "Former Roman and Sasanian worlds give way to successor kingdoms, Byzantine continuity, and early Islamic expansion.",
        scheme: "world-history",
        sourceIds: ["locLateAntiquity", "historyIslam"],
      },
      {
        id: "caliphates-tang-song-and-feudal-worlds",
        name: "High Medieval Networks",
        startYear: ce(750),
        endYear: ce(1200),
        color: HUMAN_HISTORY_COLORS.caliphatesTangSongAndFeudalWorlds,
        description:
          "Regional powers and trade systems become denser across Afro-Eurasia, linking courts, cities, faiths, and merchant routes.",
        scheme: "world-history",
        sourceIds: [
      ...
      {
        id: "mongol-and-high-medieval-age",
        name: "Mongol Age",
        startYear: ce(1200),
        endYear: ce(1350),
        color: HUMAN_HISTORY_COLORS.mongolAndHighMedievalAge,
        description:
          "Mongol conquest briefly joins much of Eurasia into shared imperial and commercial circuits, intensifying both exchange and disruption.",
        scheme: "world-history",
        sourceIds: ["britannicaMongolEmpire", "cambridgeWorldHistory5001500"],
      },
      {
        id: "late-medieval-recovery-and-early-global-turn",
        name: "Late Medieval Turn",
        startYear: ce(1350),
        endYear: ce(1500),
        color: HUMAN_HISTORY_COLORS.lateMedievalRecoveryAndEarlyGlobalTurn,
        description:
          "Plague, recovery, state-building, Renaissance culture, and new maritime ambitions push medieval systems toward early modern patterns.",
        scheme: "world-history",
        sourceIds: ["britannicaMiddleAges", "britannicaRenaissance"],
      },
    ],
  },
  {
